...
def main():
    ...
    st.markdown("Take an interactive practice test with 54 questions. Answer one question at a time and get immediate feedback.")
    ...
    # Generate initial test if none exists
    if not st.session_state.test_generated:
        with st.spinner("Generating your practice test..."):
            generate_new_test()
